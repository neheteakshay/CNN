...
model = classifier.fit_generator(training_set,steps_per_epoch = 8000,epochs = 1,validation_data = test_set,validation_steps = 2000)
...
test_image = image.load_img('C:\Users\nehet\Downloads\12.jpeg', target_size = (64, 64))
